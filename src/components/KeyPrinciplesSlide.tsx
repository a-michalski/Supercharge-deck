import { Eye, ListChecks, ShieldCheck, RotateCcw } from 'lucide-react';
  ...
  const principles = [
    {
      ...
      tips: [
        ...
        'Wskaż istniejące komponenty do reużycia'
      ],
      color: '#46BAD8'
    },
    {
    ...
    <div className="w-full max-w-6xl mx-auto space-y-8">
      ...
      >
        <Card className="bg-gradient-to-r from-[#FEBE42] to-[#FFBF42] border-[#FEBE42] shadow-lg p-6">
          <p className="text-xl text-black mb-2" style={{ fontWeight: 800 }}>
