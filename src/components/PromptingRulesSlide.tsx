import { Shield, Target, MessageSquare, Lock } from 'lucide-react';
      ...
      >
        <Card className="bg-gradient-to-r from-[#FEBE42] to-[#FFBF42] border-[#FEBE42] shadow-lg p-6">
          <div className="text-center">
            <h3 className="text-2xl text-black mb-3" style={{ fontWeight: 800 }}>🎯 Najważniejsze</h3>
