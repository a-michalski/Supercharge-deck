import { GitBranch, Save, ListChecks, Eye, FileCode, Route, RotateCcw } from 'lucide-react';
    ...
    <div className="w-full max-w-6xl mx-auto space-y-8">
      ...
      >
        <Card className="bg-gradient-to-r from-[#FEBE42] to-[#FFBF42] border-[#FEBE42] shadow-lg p-8 text-center">
          <h3 className="text-2xl text-black mb-4" style={{ fontWeight: 800 }}>💡 Ostatnia myśl</h3>
          <p className="text-lg text-black mb-2">
            <strong style={{ fontWeight: 700 }}>AI nie zastąpi Was jako developerów.</strong>
          </p>
